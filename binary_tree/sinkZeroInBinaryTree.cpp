...
void sinkZero(BinaryTree *root)
{
	...
	while(cur)
	{
		...
		else if(cur->right && cur->right->data != 0)
		{
...
int main()
{
	...
	root->left->left->right = new BinaryTree(0);
	...
	root->left->left->left->left = new BinaryTree(12);
	root->left->left->left->right = new BinaryTree(13);
